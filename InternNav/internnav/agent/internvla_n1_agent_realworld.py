...
class InternVLAN1AsyncAgent:
    def __init__(self, args):
        ...
        from transformers import BitsAndBytesConfig     #to fit in smaller GPU memory
        ...
        self.model = InternVLAN1ForCausalLM.from_pretrained(
            ...
            ),    #to fit in smaller GPU memory
        )
        self.model.eval()
        #self.model.to(self.device)     #to fit in smaller GPU memory
